...
#----------------------------------------------------------------------------------
# ricosett fix
# http://openremote.org/display/docs/OpenRemote+2.0+Developer+Reference
#----------------------------------------------------------------------------------
#    if ((device['category'] == THERMOSTAT) and ('mode' in device.keys())):
#        print "device in device.py "
#        print device
    if ((device['category'] == THERMOSTAT) and ('mode' in device.keys())):
 #       mode, heat, cool = device['mode'], device['heatsp'], device['coolsp']
        mode, heat, cool = device['mode'], device['heat'], device['cool']
...
#----------------------------------------------------------------------------------
# ricosett fix
# http://wiki.micasaverde.com/index.php/Luup_Variables#Thermostat
#{u'category': 5, u'room': 0, u'parent': 0, u'altid': u'', u'name': u'Aiconditioner ZoneThermostat', u'id': 183, u'subcategory': 1}
#
#    {
#      "name": "Central AC",
#      "altid": "2",

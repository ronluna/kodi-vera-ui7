...
class HVAC( xbmcgui.WindowXMLDialog ):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.heat = Temperature( self.device['heat'], self.temperatureUnit ) 
        self.cool = Temperature( self.device['cool'], self.temperatureUnit )
...
#           focusedControl = action.getButtonCode()
        except :
           return
...
(ACTION_MOVE_UP, ACTION_MOVE_RIGHT, ACTION_MOUSE_LEFT_CLICK):
    ...
    def update_heat(self, slider=True):
        ...
        self.label_heat().setLabel( \
                u'%.1f \xb0%s' % (int(self.heat.value), self.heat.unit) ) 
    ...
    def update_cool(self, slider=True):
        ...
        self.label_cool().setLabel( \
                u'%.1f \xb0%s' % (int(self.cool.value), self.cool.unit) ) 
    ...
    def commit(self):
        ...
        try:
            ...
            heatsp = int(self.heat.value)
            coolsp = int(self.cool.value)
